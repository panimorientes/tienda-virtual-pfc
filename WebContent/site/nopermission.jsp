					...
					<div class="tabbed">
						...
						<div class="tab-content" style="display: block;">
							<div class="product">
								...
								<center>
									<font style="color: #ff0000; font-weight: bold; font-size: 20pt">Área restringida</font><div style="height:20px"></div> 
									No tiene permiso para entrar en esta sección<br>
									Buen intento, pero no ha colado.<br>
									Puede <a href="">volver atrás</a> o <a href="">ir a la página inicial</a>.
									<div style="margin-top: 20px;"></div>
									<img src="img/bart.png" height=200px />
								</center>
