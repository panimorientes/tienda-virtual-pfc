	...
	<div id="main">
		<div class="shell">
			...
			<div id="content">
				...
				<div class="tabs">
					<ul>
						<li><a href="#" class="active"><span>Acerca de...</span></a></li>
					</ul>
				</div>
				<!-- Tabs -->
						...
						<div class="tab-content" style="display: block;">
							<div class="product">
								...
								<ul>
									...
									<center>
										<font style="color: #000000; font-weight: bold; font-size: 20pt">Práctica de ISO-2</font><br>
										<div style="height: 15px"></div>
										<font style="color: #888888; font-weight: bold; font-size: 12pt">Primer cuatrimestre</font>
										<div style="height: 20px"></div>
										<font style="color: #000000">Esta tienda online ha sido desarrollada por:</font>
										<div style="height: 10px"></div>
										Sergio García Mondaray<br>
										David Antonio Pérez Zaba<br>
										Gabriel Alises Cano<br>
										Jorge Merino García
										<div style="height: 20px"></div>
										<img src="img/hardwork.png" height=200px style="margin-right: 10px"/>
